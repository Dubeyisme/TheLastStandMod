...
HERO_REVIVED_RESPONSE = {
  {
    -- Rikimaru
    RIK = "riki_riki_thanks_01",
    -- Pangolier
    PNG = "pangolin_pangolin_respawn_05",
    -- Sniper
    SNI = "sniper_snip_thanks_01",
    -- Techies
    TEC = "techies_tech_respawn_11",
    -- Lina
    LIN = "lina_lina_respawn_02",
    -- Furion
    FUR = "furion_furi_thanks_01",
    -- Winter Wyvern
    WWY = "winter_wyvern_winwyv_thanks_03",
    -- Kunkka
    KUN = "kunkka_kunk_respawn_01",
    -- Beastmaster
    BMA = "beastmaster_beas_thanks_02",
    -- Omniknight
    OMN = "omniknight_omni_thanks_02",
  },{
    -- Rikimaru
    RIK = "riki_riki_thanks_02",
    -- Pangolier
    PNG = "pangolin_pangolin_thanks_01",
    -- Sniper
    SNI = "sniper_snip_thanks_02",
    -- Techies
    TEC = "techies_noba_tech_thanks_03",
    -- Lina
    LIN = "lina_lina_thanks_03",
    -- Furion
    FUR = "furion_furi_thanks_02",
    -- Winter Wyvern
    WWY = "winter_wyvern_winwyv_thanks_02",
    -- Kunkka
    KUN = "kunkka_kunk_thanks_03",
    -- Beastmaster
    BMA = "beastmaster_beas_thanks_01",
    -- Omniknight
    OMN = "omniknight_omni_respawn_04",
  }
}
